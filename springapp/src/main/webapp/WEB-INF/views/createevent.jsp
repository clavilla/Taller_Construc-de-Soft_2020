				...
				<div class="col-lg-8">
                    ...
                    <option><c:out value="${event.tipo}" /></option>
						...
						<div class="input-group mb-3">
							...
							<textarea required name="description" rows="8" cols="80"
								placeholder="Descripción del evento" class="form-control"></textarea>
						</div>
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input required type="date" name="startDate" id="fecha_inicio"
									value="" class="form-control" placeholder="Fecha de inicio">
								<div class="mx-3 mt-1">
								...
								<input required type="time" name="time" id="time" value=""
							...
							<div class="input-group mb-3">
								...
								<input required type="date" name="endDate" id="endDate" value=""
							...
							<div class="input-group mb-3">
								...
								<input required type="number" name="dayQuantity" value=""
							...
							<input type="submit" name="crear"
								class="btn btn-light btn-lg btn-block" value="Crear"></input>
					</form>
