            ...
            <form method="POST">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <!--  select required class="form-control" id="tipo_evento" name="idType">-->
                  <input required type="number" name="idType" value="" class="form-control" placeholder="Selecciona un tipo de evento">
              ...
              <div class="input-group mb-3">
                ...
                <input required type="text" name="startDate" value="" class="form-control" placeholder="Fecha de inicio">
                <div class="mx-3 mt-1">
                ...
                <input required type="text" name="time" value="" class="form-control" placeholder="Hora">
              </div>
              ...
              <div class="input-group mb-3">
                ...
                <input required type="text" name="endDate" value="" class="form-control" placeholder="Fecha de finalización">
              </div>
              ...
              <div class="input-group mb-3">
                ...
                <input required type="text" name="dayQuantity" value="" class="form-control" placeholder="Duración">
                <input required type="text" name="duration" value="" class="form-control" placeholder="Duración">
