			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a class="nav-link"
						href="events.htm">Volver a eventos</a></li>
		...
		<div class="container pt-3">
			<div class="row">
				<div class="col-lg-8">
					...
					<label>Modifica los datos del evento</label>
					...
					<form class="" method="POST">
						<div class="input-group mb-3">
							...
							<input required type="text" name="name" value="${model.eventmodify.name}"
						...
						<div class="input-group mb-3">
							...
							<textarea required name="description" rows="8" cols="80" class="form-control">${model.eventmodify.description}</textarea>
						</div>
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input required type="date" name="startDate" id="fecha_inicio"
									value="${model.eventmodify.startDate}" class="form-control" placeholder="Fecha de inicio">
								<div class="mx-3 mt-1">
								...
								<input required type="time" name="time" id="time" value="${model.eventmodify.time}"
							...
							<div class="input-group mb-3">
								...
								<input required type="date" name="endDate" id="endDate" value="${model.eventmodify.endDate}"
							...
							<div class="input-group mb-3">
								...
								<input required type="number" name="dayQuantity" value="${model.eventmodify.dayQuantity}"
									class="form-control" placeholder="Duración"> <select
									required class="form-control" name="duration" id="tipo_evento">
									<option disabled selected>Selecciona la unidad de
										tiempo</option>
							...
							<input type="submit" name="crear"
								class="btn btn-info btn-lg btn-block" value="Modificar"></input>
					</form>
