							...
							<div class='col-md-6 col-lg-4 mb-4'>
								<div class='card'>
									...
									<ul class='list-group list-group-flush'>
										...
										<a href="/springapp/modifyevent.htm?id=<c:out value=" ${event.id}" />"> 
											<input type="submit" value="Modificar" class="btn btn-info btn-block"> </a>
											<br />	
										<a href="/springapp/eliminarEvento.htm?id=<c:out value=" ${event.id}" />"
